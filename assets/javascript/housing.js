...
$("#compareCity").on("click", function (event) {
	...
	city2 = city2.replace(/\s/g, '');  //removes spaces
...
function drawHousing() {
	...
	if (compareButton === 0) {
		...
		for (var i = 0; i < length; i++) {
			...
			info.html("<td><a class='openInfo' index=" + i + " href='" + obj[i].url + "'>" + obj[i].name + "</a></td><td>$" + obj[i].zindex + "</td>");
		...
		for (var i = 0; i < length; i++) {
			...
			info.html("<td><a class='openInfo2' index=" + i + " href='" + object2[i].url + "'>" + object2[i].name + "</a></td><td>$" + object2[i].zindex + "</td>");
...
$(document).on("click", "#close", function () {
	...
	$("#houseData").attr("class", "col-md-3 col-xs-12 col-sm-6");
...
$(document).on("click", "#close2", function () {
	...
	$("#houseData2").attr("class", "col-md-3 col-xs-12 col-sm-6");
